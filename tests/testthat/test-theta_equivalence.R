test_that("theta_equivalence works, female test data", {
  "ptg_stud_f_train"
  "ptg_stud_f_test"
  "ptg_stud_m_train"
  "ptg_stud_m_test"
  ...
  te_out <- theta_equivalence(model_female, model_male, test_data,
                              r, alpha)
...
test_that("theta_equivalence works, male test data", {
  "ptg_stud_f_train"
  "ptg_stud_f_test"
  "ptg_stud_m_train"
  "ptg_stud_m_test"
  ...
  crit_value <- qt(alpha, df = n - 1, lower.tail = FALSE)
  equiv <- (t_stat < crit_value)
  te_out <- theta_equivalence(model_male, model_female, test_data,
                              r, alpha)
  expect_equal(te_out$equivalence, equiv)
  expect_equal(te_out$test_statistic, t_stat)
  expect_equal(te_out$critical_value, crit_value)
